...
void solve()
{
	if(!strcmp(op, "Same") || !flag) { printf("0.00\n"); flag = 0; return; }
	Point o;
	Vector v1, v2;
	o = Point((p1.x+p2.x)/2, (p1.y+p2.y)/2);
	if(op[0] == 'H')
	{
		v1 = Normal(p1-p2);
		P = CutPolygon(P, o, o+v1*1);
...
{
	flag = 1;
	Point A = Point(0, 0), B = Point(10, 0), C = Point(10, 10), D = Point(0, 10);
